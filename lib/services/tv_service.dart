...
class Tvservice {
  ...
  static Future<Map<String, dynamic>> searchMovies(
    ...
    final response = await http.get(
      Uri.parse(
          '$baseUrl/search/tv?query=$query&page=$page&include_adult=false&language=en-US'),
      headers: {
  ...
  static Future<Map<String, dynamic>> fetchNowAiringTv(int page) async {
    final response = await http.get(
      Uri.parse(
  ...
  static Future<Map<String, dynamic>> fetchOntheairTv(int page) async {
    final response = await http.get(
      Uri.parse(
  ...
  static Future<void> playYoutubeTrailer(
    ...
    print("object youtube url : $youtubeUrl");
    if (youtubeUrl != null) {
